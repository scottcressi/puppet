...
mod        'accounts',              :git  =>  'https://github.com/deric/puppet-accounts',                     :ref  =>  'v2.0.0'
mod        'apt',                   :git  =>  'https://github.com/puppetlabs/puppetlabs-apt',                 :ref  =>  'v7.5.0'
mod        'archive',               :git  =>  'https://github.com/voxpupuli/puppet-archive',                  :ref  =>  'v4.5.0'
...
mod        'filebeat',              :git  =>  'https://github.com/pcfens/puppet-filebeat',                    :ref  =>  'v4.7.0'

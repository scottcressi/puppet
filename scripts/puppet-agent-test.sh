...
test(){
    ...
    docker run --net pupperware_default --name="$NAME" -d -v ~/repos/personal/puppet/scripts/facts.txt:/opt/puppetlabs/facter/facts.d/facts.txt --privileged -v /sys/fs/cgroup:/sys/fs/cgroup:ro centos/systemd-puppet
